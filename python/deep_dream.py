'''
    This code is an example of using deep neural networks to merge images with
    features layers from a google's pre-trained neural network.
...
def main():
 ...
 ############################################################
    ...
    #open image
    img0 = PIL.Image.open('../data/images/red.jpg')
